...
let EventSubChannelRaidEvent = class EventSubChannelRaidEvent extends common_1.DataObject {
    ...
    async getRaidingBroadcaster() {
        return (await this._client.users.getUserById(this[common_1.rawDataSymbol].from_broadcaster_user_id));
    }
    /**
    ...
    async getRaidedBroadcaster() {
        return (await this._client.users.getUserById(this[common_1.rawDataSymbol].to_broadcaster_user_id));
    }
    /**
...
EventSubChannelRaidEvent = tslib_1.__decorate([
    (0, common_1.rtfm)('eventsub', 'EventSubChannelRaidEvent', 'raidedBroadcasterId')
