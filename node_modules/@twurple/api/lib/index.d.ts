...
export type { HelixChannelEmoteSubscriptionTier, HelixEmoteImageScale, HelixEmoteScale, HelixEmoteFormat, HelixEmoteThemeMode, HelixChatUserColor, HelixChatAnnouncementColor, 
/** @deprecated */
HelixChatAnnouncementColor as HelixChatAnnoucementColor } from './interfaces/helix/chat.external';
export type { HelixUpdateChatSettingsParams, HelixSendChatAnnouncementParams, 
/** @deprecated */
HelixSendChatAnnouncementParams as HelixSendChatAnnoucementParams, HelixChatBadgeScale } from './interfaces/helix/chat.input';
...
export type { HelixEventSubTransportOptions, HelixEventSubWebSocketTransportOptions, HelixEventSubWebHookTransportOptions, HelixPaginatedEventSubSubscriptionsResult } from './interfaces/helix/eventSub.input';
