 ...
 */
export declare type HelixChatAnnoucementColor = 'blue' | 'green' | 'orange' | 'purple' | 'primary';
/**
...
export declare class HelixChatApi extends BaseApi {
     ...
     */
    sendAnnouncement(broadcaster: UserIdResolvable, moderator: UserIdResolvable, announcement: HelixSendChatAnnoucementParams): Promise<void>;
    /**
